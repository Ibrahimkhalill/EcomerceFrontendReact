...
const ExperienceIsuue = () => {
  ...
  const submitIssue = async () => {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_KEY}/api/save/ecomerce/issue/`,
        {
          method: "POST",
          headers: {
  ...
  const submitfeedback = async () => {
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_KEY}/api/save/feedback/`,
        {
          method: "POST",
          headers: {
            "Content-type": "application/json",
  ...
  return (
    <>
      {feedBackdata ? (
        <div
          style={{ fontSize: "1.4vw", display: "flex", alignItems: "center" }}
        >
          <img src={success} width={25} alt="" /> {feedBackdata}
        </div>
      ) : (
        <>
          ...
          {issue && (
            <div>
              ...
              >
                ...
                Choose a option that best describe your problem.
              </span>
              <div
                ref={divRef}
              ...
              >
                Please share any more details around the issue. Your feedback
                will help us improve Daraz for everyone.
              </div>
              <div className="experice_text_area">
                <textarea
